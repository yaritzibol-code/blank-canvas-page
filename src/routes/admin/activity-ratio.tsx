...
const PASOS_LEGIBLES: Record<string, string> = {
  ...
  tour_inicio: "Abrió el recorrido de Pathy",
  tour_completado: "Terminó el recorrido de Pathy",
  tour_omitido: "Saltó el recorrido de Pathy",
  tour_abandonado: "Dejó el recorrido de Pathy a medias",
