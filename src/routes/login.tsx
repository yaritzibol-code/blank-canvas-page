      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-[#F2DCDB] p-8">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-extrabold text-[#3D5D91] mb-1">¡Bienvenido de vuelta!</h1>
            <p className="text-slate-400 text-sm">Inicia sesión para continuar tu ruta de estudio</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                required
                className="h-11 border-[#F2DCDB] focus:border-[#3D5D91] focus:ring-[#3D5D91]/20"
              />
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <button type="button" className="text-[#3D5D91] text-xs font-medium hover:underline">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-11 border-[#F2DCDB] focus:border-[#3D5D91] focus:ring-[#3D5D91]/20 pr-10"
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full bg-[#3D5D91] hover:bg-[#5A86CB] text-white font-bold h-11 shadow-md shadow-[#3D5D91]/20"
            >
              {loading ? (
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <Link to="/register" className="text-[#3D5D91] font-semibold hover:underline">
              Regístrate gratis
            </Link>
          </p>
        </div>
