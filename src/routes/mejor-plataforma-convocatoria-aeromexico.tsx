...
const TABLA_RESUMEN: { criterio: string; solo: string; curso: string; flightpath: string }[] = [
  {
    criterio: "Cobertura de las 5 fuentes del temario",
    solo: "Depende del material",
    curso: "Depende",
    flightpath: "Sí — ATP, PHAK, Jeppesen, CPAM y Anexo 10",
  },
  {
    criterio: "Práctica por fuente con explicación",
    solo: "No",
    curso: "Depende",
    flightpath: "Sí — por capítulos",
  },
  {
    criterio: "Simulacros cronometrados",
    solo: "No",
    curso: "Depende",
    flightpath: "Sí",
  },
  {
    criterio: "Medición de avance",
    solo: "No",
    curso: "Rara vez",
    flightpath: "Sí — por fuente y capítulo",
  },
  {
    criterio: "Independencia y transparencia",
    solo: "—",
    curso: "Depende",
    flightpath: "Sí — sin afiliación, auditable gratis",
  },
];
          ...
          <div className="mx-auto max-w-[1100px] px-6 lg:px-8">
            <div className="rounded-3xl bg-white border border-ink/8 shadow-card p-6 lg:p-7">
                ...
                <table className="w-full min-w-[640px] border-collapse text-[13.5px]">
                  <thead>
                    <tr className="text-left text-[11px] uppercase tracking-[0.14em] text-ink/45">
                      ...
                      <th className="py-2 pr-4 font-bold">Preparador o curso</th>
              ...
              <p className="mt-3 text-[12px] text-ink/40">
                “Depende” significa que varía según el preparador o material concreto — verifícalo
                antes de pagar. Lo de FlightPath se audita gratis con la cuenta Básica.
              </p>
            </div>
          </div>
        </section>
