  ...
  const g: Record<IconName, React.ReactNode> = {
    ...
    help: (
      <>
        ...
        <path d="M9.5 9.5a2.5 2.5 0 1 1 3.2 2.4c-.7.3-1.2.9-1.2 1.6v.4" {...p} />
    ...
    settings: (
      <>
        ...
        <path
          d="M19.4 13a1.7 1.7 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-2.9 1.2V19a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-2.9-1.2l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1A1.7 1.7 0 0 0 4.6 13H4.5a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.2-2.9l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1A1.7 1.7 0 0 0 11 4.6V4.5a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 2.9 1.2l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0 1.2 2.9h.1a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.6 1z"
          {...p}
        />
      </>
    ),
    ...
    building: (
      <>
        <path d="M4 21V6l7-3v18M11 21h9V10l-9-3" {...p} />
        <path d="M14 11h2M14 14h2M14 17h2M7 8v.01M7 12v.01M7 16v.01" {...p} />
      </>
    ),
...
const NAV_SECTIONS: {
  label: string;
  items: { icon: IconName; label: string; path: string; locked?: boolean; nuevo?: boolean }[];
}[] = [
  {
    label: "Principal",
    items: [
                  ...
                  {showLock && (
                    <span
                      ...
                      style={{
                        ...
                        letterSpacing: "0.1em",
                        boxShadow:
                          "0 0 0 1px rgba(255,255,255,0.25), 0 4px 12px -4px rgba(228,112,140,0.8)",
                        whiteSpace: "nowrap",
                      }}
                    >
                  ...
                  {item.nuevo && !showLock && (
                    <span
                      ...
                      style={{
                        ...
                        letterSpacing: "0.1em",
                        boxShadow:
                          "0 0 0 1px rgba(255,255,255,0.3), 0 4px 14px -4px rgba(18,178,107,0.95)",
                        whiteSpace: "nowrap",
                      }}
                    >
                      <span
...
function DashboardLayout() {
  ...
  /**
   * Un learning path abierto ocupa la pantalla completa: sin barra lateral ni
   * topbar, para que el recorrido deje de verse como un HTML metido en una
              ...
              >
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 shrink-0 justify-self-end">
                  <span className="hidden lg:inline-flex">
                    <LiveIndicator state={live} compact />
                  </span>
                  <div
                    style={{
                      background: "#FBF7EC",
              ...
              >
                ...
                {(snapshot.topMateria || snapshot.avgSessionMin !== null) && (
                  <div className="hidden md:flex items-center gap-2 opacity-85 min-w-0">
                    {snapshot.topMateria && (
                      <span className="truncate">
                        Tu materia más practicada: <strong>{snapshot.topMateria}</strong>
                      </span>
                    )}
                    {snapshot.topMateria && snapshot.avgSessionMin !== null && (
                    ...
                    {snapshot.avgSessionMin !== null && (
                      <span className="whitespace-nowrap">
                        Promedio: <strong>{snapshot.avgSessionMin} min</strong>
                      </span>
                    )}
                  </div>
                )}
