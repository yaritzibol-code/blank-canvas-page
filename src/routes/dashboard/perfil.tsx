...
function PerfilPage() {
  ...
  // Antes vivían después del early return: los hooks deben correr siempre.
  ...
  const saveEdit = () => {
    ...
    setInfo({
      ...draft,
      nombre: draft.nombre.trim() || user.nombre,
      ciaac: fmtFechaCiaac(draft.ciaac || null),
    });
    setEditing(false);
    setSaved(true);
    ...
    >
      ...
      >
        ...
        <div style={{ flex: "1 1 200px", zIndex: 1, minWidth: 0 }}>
          ...
          >
            {info.nombre.split(" ").slice(0, 2).join(" ")}
          </div>
          <div
            style={{
              fontSize: ".82rem",
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            >
              <Icon n="plane" size={13} /> {user.planNombre}
            </span>
            <span
              style={{
                padding: "4px 12px",
            ...
            >
              <Icon n="flame" size={13} /> {stats.streak} {stats.streak === 1 ? "día" : "días"} de
              racha
            </span>
            <span
              style={{
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            >
              {editing ? (
                <>
                  <Icon n="check" size={15} /> Guardar cambios
                </>
              ) : (
                <>
                  <Icon n="pencil" size={15} /> Editar perfil
                </>
              )}
            </button>
          </div>
          ...
          {[
            {
              ...
              label: "CIAAC",
              icon: "help",
              desc: "Las 12 materias del examen",
            },
            {
              id: "linea-aerea" as const,
              label: "Línea Aérea",
              icon: "plane",
              desc: "Manuales de la convocatoria",
            },
          ].map((r) => {
      ...
      >
        <div>
          ...
          >
            <Icon n="plane" size={18} /> {user.planNombre} — FlightPath
          </h3>
      ...
      <CompassLogCard userId={user.id} verHub style={{ marginBottom: 24 }} />
    </div>
  );
}
