...
async function signInWithGoogle(setError: (m: string) => void, redirectTo?: string) {
  try {
    ...
    if (res.error) {
      setError(res.error.message || "No pudimos iniciar sesión con Google.");
      return;
    }
  ...
  const g: Record<IconName, React.ReactNode> = {
    gift: (
      <>
        ...
        <path
          d="M4 13h16M12 9v11M12 9S10.5 4.5 8.5 5.2 8.8 9 12 9zM12 9s1.5-4.5 3.5-3.8S15.2 9 12 9z"
          {...p}
        />
      </>
    ),
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <label style={{ display: "flex", alignItems: "flex-start", gap: 10, cursor: "pointer" }}>
        ...
        />
        <span style={{ fontSize: "0.82rem", color: "#93A4BF", lineHeight: 1.4 }}>
      ...
      <label style={{ display: "flex", alignItems: "flex-start", gap: 10, cursor: "pointer" }}>
        ...
        <span style={{ fontSize: "0.82rem", color: "#93A4BF", lineHeight: 1.4 }}>
          Acepto los{" "}
          <Link to="/legal" style={{ color: "#C7A052", fontWeight: 600, textDecoration: "none" }}>
      ...
      <p style={{ textAlign: "center", fontSize: "0.78rem", color: "#93A4BF", marginTop: 4 }}>
        ¿Ya tienes cuenta?{" "}
        <button
          type="button"
          onClick={onSwitch}
  ...
  if (showReset) {
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        {resetOk && (
          <p style={{ ...errorTextStyle, color: "#2ecc71" }}>
            {resetMsg ?? "Revisa tu correo para continuar."}
          </p>
        )}
        <SubmitButton loading={false} onClick={handleReset}>
          Enviar enlace
        </SubmitButton>
...
function Divider() {
  return (
    ...
    >
      <span style={{ flex: 1, height: 1, background: "rgba(255,255,255,.12)", display: "block" }} />
      o
      <span style={{ flex: 1, height: 1, background: "rgba(255,255,255,.12)", display: "block" }} />
    </div>
  );
  ...
  return (
    <button
      ...
      style={{
        ...
        gap: 10,
        padding: 12,
        border: `1.5px solid ${hovered ? "#93A4BF" : "rgba(255,255,255,.12)"}`,
        borderRadius: 12,
        background: hovered ? "#050F22" : "#0A1B33",
        fontSize: "0.9rem",
        fontWeight: 600,
        color: INK,
        cursor: "pointer",
...
function SubmitButton({
  ...
  return (
    <button
      ...
      style={{
        padding: 14,
        background: loading ? "#93A4BF" : hovered ? "#8A6A25" : "#C7A052",
        color: "#0A1B33",
        border: "none",
        borderRadius: 12,
        fontSize: "0.95rem",
        ...
        <div style={{ maxWidth: 380, textAlign: "center" }} className="hidden md:block">
          <div
            style={{
              ...
              borderRadius: "50%",
              overflow: "hidden",
              boxShadow: "0 20px 50px -24px rgba(15,26,51,0.55)",
          ...
          >
            ¡Bienvenido a<br />
            <span style={{ color: "#C7A052" }}>FlightPath!</span>
          </h2>
          <p style={{ color: "#93A4BF", fontSize: "0.95rem", lineHeight: 1.6, marginBottom: 28 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10, textAlign: "left" }}>
            {PERKS.map((perk) => (
              ...
              >
                ...
                <span style={{ fontSize: "0.85rem", color: "#8A6A25", fontWeight: 500 }}>
                  {perk.text}
                </span>
              </div>
            ))}
