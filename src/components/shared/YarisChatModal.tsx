...
export function YarisChatModal({
  ...
  return (
    <div
      onClick={onClose}
      style={{ position: "fixed", inset: 0, zIndex: 4000, background: "rgba(3,8,15,.62)", fontFamily: FONT }}
    >
      <div
      ...
      >
        ...
        <div
          ref={listRef}
          style={{ flex: 1, overflowY: "auto", padding: 16, display: "flex", flexDirection: "column", gap: 10, background: "rgba(255,255,255,.03)" }}
        >
          {messages.map((m, i) =>
            m.from === "yaris" ? (
              <div
                ...
                style={{
                  ...
                  fontSize: ".85rem", color: "#FFFFFF", lineHeight: 1.5,
              ...
              >
                ...
                {m.cite && (
                  <div style={{ marginTop: 6, fontSize: ".72rem", color: "#93A4BF" }}>Fuente: {m.cite}</div>
                )}
              </div>
            ) : (
              <div
          ...
          {typing && (
            <div style={{ alignSelf: "flex-start", fontSize: ".78rem", color: "#93A4BF", fontStyle: "italic", padding: "2px 6px" }}>
        ...
        {/* Input */}
        <div style={{ padding: 14, borderTop: "1px solid rgba(255,255,255,.12)", display: "flex", gap: 8, flexShrink: 0, background: "rgba(255,255,255,.04)" }}>
          <input
            value={input}
            ...
            style={{
              ...
              border: "1.5px solid rgba(255,255,255,.12)", borderRadius: 6,
              fontSize: ".85rem", fontFamily: FONT, color: "#FFFFFF",
              outline: "none", background: "rgba(255,255,255,.06)",
            }}
            onFocus={(e) => (e.target.style.borderColor = "#C7A052")}
