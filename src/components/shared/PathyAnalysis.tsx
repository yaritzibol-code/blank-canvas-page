...
function BarraMateria({ m }: { m: RutaPerf }) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
      ...
      >
        <div
          style={{ height: "100%", borderRadius: 10, background: color, width: `${m.avg ?? 0}%` }}
        />
      </div>
      <span
        style={{
...
function Bloque({
  ...
  return (
    <div
      style={{ background: "white", border: "1px solid #E8EEF6", borderRadius: 16, padding: 18 }}
    >
      <div
        style={{
          fontSize: ".72rem",
    ...
    <section style={{ marginBottom: 28 }}>
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 260, zIndex: 1 }}>
          ...
          <p style={{ fontSize: ".88rem", color: "rgba(255,255,255,.72)", lineHeight: 1.6 }}>
            {report.resumen}
          </p>
        </div>
      </div>
      ...
      >
        <Metric
          ...
          nota={
            report.aciertos.muestra > 0
              ? `Sobre ${report.aciertos.muestra} preguntas respondidas`
              : "Sin preguntas en los últimos 30 días"
          }
        />
        <Metric
              ...
              {materias.debiles.length > 0 && (
                <div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    {materias.debiles.map((m) => (
                      <BarraMateria key={m.key} m={m} />
                    ))}
                  </div>
                </div>
              )}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              {report.manuales.sinPracticar.length > 0 && (
                ...
                >
                  ...
                  {report.manuales.sinPracticar.map((m) => m.name).join(", ")}.
                </div>
              )}
            </div>
          )}
