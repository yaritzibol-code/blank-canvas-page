...
export function seedFlashcards(questions: BankQuestion[]): FlashCardItem[] {
  const aeroCards: Array<[string, string]> = [
    [
      "¿Cuáles son las 4 fuerzas que actúan sobre una aeronave en vuelo?",
      "Sustentación, Peso, Empuje y Resistencia. En vuelo recto y nivelado estas fuerzas están en equilibrio.",
    ],
    [
      "¿Qué establece el Principio de Bernoulli?",
      "En un fluido en movimiento, al aumentar la velocidad disminuye la presión estática. Esto explica cómo el ala genera sustentación.",
    ],
    [
      "¿Qué es el ángulo de ataque?",
      "El ángulo formado entre la cuerda del ala y la dirección del viento relativo. Es fundamental para la generación de sustentación.",
    ],
    [
      "¿Qué es el ángulo crítico de ataque?",
      "El ángulo máximo de ataque antes del desplome (stall). Al superarlo, el flujo se desprende del ala y se pierde la sustentación.",
    ],
    [
      "¿Qué es el factor de carga?",
      "La relación entre la sustentación total y el peso de la aeronave (n = L/W). En vuelo recto y nivelado es igual a 1.",
    ],
    [
      "¿Qué es la resistencia inducida?",
      "Resistencia generada como consecuencia de la producción de sustentación. Aumenta cuando aumenta el ángulo de ataque.",
    ],
    [
      "¿Cuál es la diferencia entre estabilidad estática y dinámica?",
      "La estabilidad estática es la tendencia inicial a regresar al equilibrio. La dinámica describe el comportamiento a lo largo del tiempo después de una perturbación.",
    ],
    [
      "¿Qué es el motor crítico en una aeronave multimotor?",
      "El motor cuya falla produce el mayor efecto adverso sobre el control y rendimiento de la aeronave. En aviones con hélices girando en el mismo sentido es el izquierdo.",
    ],
  ];
...
function seedHistory() {
  ...
  const quizzes: QuizAttempt[] = [
    ...
    {
      materias: ["aerodinamica", "meteorologia", "legislacion"],
      total: 30,
      correct: 27,
      durationMin: 22,
      daysAgo: 3,
  ...
  const simPcts: Record<string, number> = {
    aerodinamica: 80,
    "aeronaves-motores": 80,
    legislacion: 70,
    medicina: 85,
    meteorologia: 52,
    navegacion: 65,
    "servicios-transito": 70,
    comunicaciones: 90,
    "manuales-ais": 80,
    "factores-humanos": 88,
    "seguridad-aerea": 90,
  ...
  activity.push(
    {
      id: "act_flash_seed_001",
      userId,
      date: daysAgoISO(1, 20),
      kind: "flashcards",
      label: "Flashcards — Definiciones y clasificación",
      score: 75,
      durationMin: 12,
    },
    {
      id: "act_tema_seed_001",
      userId,
      date: daysAgoISO(4, 18),
      kind: "tema",
      label: "Learning Path — Fuerzas en vuelo",
      score: null,
      durationMin: 18,
    },
  );
...
function seedBitacora(): BitacoraEntry[] {
  ...
  return [
    mk(
      ...
      3,
      ["Meteorología"],
      "Hoy por fin entendí la diferencia entre METAR y TAF. El simulador de la semana pasada me ayudó a ver mis huecos.",
      "¡Buen ritmo, María! Notaste tu propio avance en Meteorología: eso es metacognición de piloto. Mañana te recomiendo un cuestionario corto para consolidar.",
    ),
    mk(
      3,
      "alert",
      ...
      3,
      2,
      ["Meteorología", "Navegación Aérea"],
      "Me frustré con los cálculos de deriva. Siento que me falta base de trigonometría.",
      "Respira. La deriva confunde a todos al inicio. Te propongo 15 minutos de flashcards de Navegación mañana y luego lo hablamos con Yaris.",
    ),
    mk(
      6,
      "sun",
      ...
      4,
      [],
      "¡Terminé el simulador completo! 4 horas intensas pero lo logré. 73% general.",
      "¡Enorme, María! Completar un simulador de 310 preguntas es un hito. Tu 73% marca la línea base: ahora vamos por el 80%.",
    ),
    mk(
      9,
      "minus",
      ...
      "Día pesado en la escuela, casi no pude concentrarme. Leí un rato de legislación.",
      "Los días grises también cuentan: 20 minutos valen más que cero. Mañana intenta tu sesión antes de la escuela, tu concentración suele ser mejor temprano.",
    ),
    mk(
      12,
      "checkCircle",
      ...
      3,
      ["Factores Humanos"],
      "Factores humanos se me da bien. El modelo SHELL tiene mucho sentido.",
      "Factores Humanos ya es una de tus fortalezas (88% de aciertos). Mantenla con un repaso semanal y enfoquemos la energía en Meteorología.",
    ),
  ];
}
  ...
  return [
    {
      id: "rem_seed_1",
      userId,
      tipo: "Sesión de estudio diaria",
      titulo: "Sesión de estudio diaria",
      sub: "Todos los días · 7:00 PM",
      hora: "19:00",
      dias: all7,
      enabled: true,
      icon: "book",
      iconBg: "rgba(61,93,145,.12)",
      tags: ["Diario", "7:00 PM"],
      ultimoEnvio: null,
    ...
    },
    {
      id: "rem_seed_2",
      userId,
      tipo: "Simulador semanal",
      titulo: "Simulador semanal",
      sub: "Sábados · 9:00 AM",
      hora: "09:00",
      dias: [false, false, false, false, false, true, false],
      enabled: true,
      icon: "clipboard",
      iconBg: "rgba(108,8,32,.12)",
      tags: ["Semanal", "Sábado"],
      ultimoEnvio: null,
      createdAt: daysAgoISO(60, 10),
    },
    {
      ...
      userId,
      tipo: "Materia débil",
      titulo: "Reforzar Meteorología",
      sub: "Lunes a viernes · 6:30 PM",
      hora: "18:30",
      dias: weekdays,
      enabled: true,
      icon: "cloud",
      iconBg: "rgba(46,204,113,.12)",
    ...
    },
    {
      ...
      sub: "Cuando esté por perderse la racha",
      hora: "21:00",
      dias: all7,
      enabled: false,
      icon: "flame",
      iconBg: "rgba(243,156,18,.14)",
      tags: ["Racha"],
      ultimoEnvio: null,
      createdAt: daysAgoISO(30, 10),
    },
  ...
  return [
    {
      ...
      recurso: "q_seed_031",
      mensaje:
        "La pregunta del rumbo verdadero y magnético tiene dos opciones que suenan casi iguales; creo que la B debería mencionar la desviación del compás con más claridad.",
      estado: "pendiente",
      notasInternas: "",
    },
    {
      ...
      mensaje:
        "No puedo abrir el manual de Aerodinámica Avanzada, me aparece el candado. ¿Es normal con la cuenta gratuita?",
      estado: "resuelto",
      notasInternas:
        "Es el comportamiento esperado del plan básico. Le expliqué por correo y le compartí los planes.",
    },
  ];
}
