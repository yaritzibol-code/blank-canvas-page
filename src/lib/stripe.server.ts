/**
 * Cliente Stripe compartido — TODO uso de Stripe pasa por aquí.
 * Rutea las llamadas por el connector gateway de Lovable (que adjunta la
 * clave secreta real), y expone `verifyWebhook` para validar firmas.
 */
